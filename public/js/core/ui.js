...
export function el(tag, props = {}, ...children) {
  ...
  for (const [k, v] of Object.entries(props)) {
    // "ausente" é ausente para QUALQUER chave, inclusive class/html/dataset. A
    // checagem ficava só no último ramo, então `class: null` chegava em
    // `className = null` e o DOM gravava a string "null" — havia 171 elementos
    // com class="null" na página, e o padrão `cond ? x : null` é usado à vontade.
