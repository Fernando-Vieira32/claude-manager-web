...
| 14 | [Docker](14-docker.md) | entregar o app para outra pessoa: imagem com o CLI dentro, roda em qualquer PC com Docker (Windows/Mac/Linux) |
...
| escrever ou rodar teste | `test/*.test.js` (ver [13](13-testes.md)) |
